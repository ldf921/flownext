...
\\msra-ts1\c$\Users\v-dinliu\AppData\Local\Continuum\anaconda3\python \\msralab\ProjectData\eHealth02\v-dinliu\Flow2D\main.py --device 0,1 --relative M --batch 8 -n hybridnet --lr_mult 0.5
```